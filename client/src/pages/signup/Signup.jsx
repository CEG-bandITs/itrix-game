...
function Signup() {
  ...
  const ChangeValue = (e) => {
    ...
    if (name === 'email') {
      ...
      if (data['passwd']['value'] !== value) error = 'password mismatch'
    }
    handleData((prev) => {
      const new_data = { ...prev }
      ...
      Register__(data).then((response) => {
        if (response[0] === true) {
          NotificationManager.success(
            'Account created successfully,wait for few sec',
          )
          setTimeout(() => {
      ...
      <div className={SignupStyle.container}>
        ...
        <form action="">
          ...
          <span className={SignupStyle.Error}>
            {data['fname']['error'] !== 'initial' && data['fname']['error']}
          </span>
          ...
          />
          <span className={SignupStyle.Error}>
            {data['lname']['error'] !== 'initial' && data['lname']['error']}
          </span>
          ...
          />
          <span className={SignupStyle.Error}>
            {data['email']['error'] !== 'initial' && data['email']['error']}
          </span>
          ...
          />
          <span className={SignupStyle.Error}>
            {data['clg']['error'] !== 'initial' && data['clg']['error']}
          </span>
          ...
          />
          <span className={SignupStyle.Error}>
            {data['passwd']['error'] !== 'initial' && data['passwd']['error']}
          </span>
          ...
          />
          <span className={SignupStyle.Error}>
            {data['cpasswd']['error'] !== 'initial' && data['cpasswd']['error']}
          </span>
