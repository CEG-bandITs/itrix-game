      ...
      <div className={styles.darkLayer}>
        ...
        <form action="" className={styles.loginBox}>
          ...
          <input type="email" 
           ...
           id="email" />
          <span className={styles.Error}> {emailError!=="initial"&&emailError}</span>
          <input
            type="password"
            name="password"
          ...
          />
          <span className={styles.Error}>{passwordError!=="initial"&&passwordError}</span>
