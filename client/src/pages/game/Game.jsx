...
function Game(props) {
  ...
  useEffect(() => {
     //party.js 
  document.querySelector(".party__button").addEventListener("click", function (e) {
...
<button className="party__button" style={{display:"none",position:"absolute",top:"50%",left:"50%",translate:"transform(-50%,-50%)"}}></button>      
      <div className="GamePage">
        <div className="game__nav">
          ...
          <span className="trophy">
            {data!==null&& 
            <div> {data['level']} <GiDiamondTrophy style={{ color: "yellow" }} /> </div>
            }
          </span>
        ...
        {
          data===null ?  <div className="message__div">
